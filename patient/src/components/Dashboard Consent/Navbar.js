        ...
        <React.Fragment>
            <AppBar sx={{background: "#10BB40", minHeight: '70px'}}>
                <Toolbar>
                    ...
                    <Button sx={{"&:hover": {backgroundColor: "#D3D3D3"}, width:"12%", marginLeft:'53%', borderRadius:'20px', background:"white", color:"black"}} variant="contained">Hospital Records</Button>
                    <Button sx={{"&:hover": {backgroundColor: "#D3D3D3"}, marginLeft:'auto', borderRadius:'20px', background:"white", color:"black"}} variant="contained">Profile</Button>
